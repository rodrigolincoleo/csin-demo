...
const clientes = [
    { nombre: 'Minera Escondida', logo: 'https://www.provetecmining.cl/wp-content/uploads/2016/11/minera-escondida.png' },
...
>
    ...
    >
        Nuestro mayor conocimiento se basa en la gran cantidad de proyectos de ingeniería en especialidades Eléctrica (Líneas Eléctricas en MT y BT, Mallas de tierra, Flujos de Potencia, análisis de SEP, Coordinación de Protecciones, Partidas de Motores, etc.), instrumentación, control, telecomunicaciones y Fibra Óptica, Radio Frecuencia, Transmisión, LTE Privada, desarrolladas por nuestros profesionales para grandes empresas mineras, tales como:
    </Typography>
    ...
    <Box
        sx={{
            ...
            alignItems: 'center',
            width: '100%',
            maxWidth: '900px', // Para limitar el ancho del slider
            mt: 3 // Margen superior para separación
        }}
    >
