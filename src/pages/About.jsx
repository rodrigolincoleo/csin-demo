  ...
  return (
    <Box
      ...
      sx={{
        ...
        alignItems: 'center',
        justifyContent: 'flex-start', // Asegura que el contenido comience desde arriba
      }}
    >
      ...
      {/* Contenido de texto */}
      <Row className="d-flex justify-content-center align-items-center" style={{ flex: 1, width: '80%' }}>
        <Typography
          variant="h3"
          gutterBottom
